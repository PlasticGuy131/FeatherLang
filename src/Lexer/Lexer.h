...
namespace Lexer
{
	enum TokenType { INT, FLOAT, STRING, ADD, SUB, MULT, DIV, GREATER, LESS, GREATERE, LESSE, EQUAL, OPENBRACKET, CLOSEBRACKET, OPENBRACE, CLOSEBRACE, KEYWORD, IDENTIFIER, END, NUMBER, NULLTYPE, POW, ANY, TYPE, ASSIGN, BOOL, DEFAULT, IDIV, MOD };
